...
export default function CustomerDetail() {
  ...
  const balance = customer.totalDeposit - customer.totalDebt;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="lg:col-span-2">
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg shadow-lg p-8 text-white">
            ...
            <div className="border-t border-blue-400 pt-6 mb-8">
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <p className="text-blue-100 text-xs font-medium mb-2">Total Deposit</p>
                  <p className="text-2xl font-semibold text-green-200">{formatCurrency(customer.totalDeposit)}</p>
                </div>
                <div>
                  <p className="text-blue-100 text-xs font-medium mb-2">Total Hutang</p>
                  <p className="text-2xl font-semibold text-red-200">{formatCurrency(customer.totalDebt)}</p>
                </div>
              </div>
            </div>
